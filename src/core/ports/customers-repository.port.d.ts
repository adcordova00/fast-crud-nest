...
export declare const CUSTOMERS_REPOSITORY_PORT = "CustomersRepositoryPort";
export interface CustomersRepositoryPort {
    ...
    validateData(id: string): Promise<{
        valid: boolean;
        errors: string[];
    }>;
    ...
    importCustomers(data: any[], options?: {
        validate?: boolean;
        merge?: boolean;
    }): Promise<{
        success: number;
    ...
    getDataExport(id: string): Promise<any>;
