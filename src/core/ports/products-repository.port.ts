...
export const PRODUCTS_REPOSITORY_PORT = 'ProductsRepositoryPort';
...
export interface ProductsRepositoryPort {
    ...
    applyDiscount(id: string, discount: { percentage?: number; amount?: number; startDate?: string; endDate?: string }): Promise<void>;
    ...
    // Category and relationship operations
    ...
    addMedia(id: string, media: { url: string; type: string; alt?: string }): Promise<void>;
    ...
    bulkImport(data: CreateProductsDto[]): Promise<{ success: number; failed: number; errors: any[] }>;
